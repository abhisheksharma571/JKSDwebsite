...
const Review = () => {
  ...
  return (
    ...
    <div className='w-full max-w-[1500px]  mx-auto pb-10'>
        ...
        <h1 className='text-2xl md:text-5xl font-bold text-orange text-center pt-10'>HAPPY CUSTOMERS & STUDENTS</h1>
            ...
            {data.map((d, index)=>(
                ...
                <div 
                key={index}
                className=' h-[350px] w-[290px] text-black rounded-lg m-6 mx-6 sm:mx-4 md:mx-2 lg:mx-6'>
