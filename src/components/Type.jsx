    ...
    return (
        <div className=' h-auto ml-20 pt-4  flex  ' >
            <div className='ml-2 pt-32 font-bold w-[50%] text-4xl' >
                ...
                <span className=' text-orange-400 ' > {typewriter}   </span>
                <br />
                ...
                <button
                    class="  h-10 mt-7  align-middle bg-orange-500  font-bold text-center uppercase     text-sm  px-5  rounded-3xl  text-black shadow-sm  hover:shadow-lg hover:bg-orange-600   relative flex items-center   pr-[50px]"
                    type="button">
                    Contact Us
                    <span class="absolute right-0 grid w-12 h-full transition-colors place-items-center bg-light-blue-600 group-hover:bg-light-blue-700">
                        ...
                        <img src={contact} alt="metamask" class="w-6 h-6 mr-2 " />
