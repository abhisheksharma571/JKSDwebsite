...
function ProjectTrInfo() {
  return (
    ...
    <div className='w-full pt-4 px-5 md:pt-20  text-[#FCFAF6] text-center md:text-left'>
    ...
    <div className='mt-8 font-normal text-white text-lg lg:text-xl pl-0 md:pl-4  '>
        <li>Duration: 3/6 Months</li>
        <li>Paid/Un Paid</li>
       </div >
       <div className='pt-3  md:pt-14 ml-0 md:ml-4 '>  
       <Link to='/enroll'>     
