...
<div className='h-[570px] w-full md:w-full md:h-screen bg-[#08528e] flex  justify-center text-center md:text-left'>
       ...
       <h1 className='md:text-5xl  text-[#FCFAF6] font-philosopher font-black text-3xl text-center sm:text-start'>Project Training</h1>
       <p className='md:text-3xl mt-10 w-full text-xl  text-center sm:text-start'>This version focuses on project training, emphasizing practical, real-world experience to build your career. Let me know if you'd like to refine it further!</p>
       <p className='md:text-lg mt-8 md:mt-10 w-[95%] text-sm text-center sm:text-start'>JKSD's Project Training Program is tailored for IT and Engineering students, including BE/BTECH, BSC(IT), BCA, MCA, MSC(IT), and Diploma holders. Under the guidance of experienced trainers, you'll work on real-world projects, gaining practical skills and industry knowledge. Our focus on hands-on experience and excellence is reflected in consistently positive feedback. This is your chance to enhance your expertise and prepare for a successful career with industry-relevant project experience!</p>
