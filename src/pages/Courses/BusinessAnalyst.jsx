...
const BusinessAnalyst = () => {
    ...
    <div className="text-white w-full lg:w-[55%] mx-4 lg:mx-6 pt-4 lg:pt-6 pl-4 lg:pl-8">
        <h1 className='text-3xl lg:text-4xl font-bold'>Business Analyst</h1>
        <p className='pt-4 text-sm lg:text-base mr-10'>
        ...
        <div className='flex flex-wrap justify-start lg:justify-evenly mt-7 mb-5'>
...
<div className=''>
    <div className='h-auto w-[90%] lg:w-[80%] mx-auto lg:mx-32'>
        <h1 className='text-center text-2xl lg:text-3xl font-bold pt-4'>Business Analyst: "Insights Driving Growth"</h1>
        ...
        <div className='flex flex-col lg:flex-row justify-center pt-5'>
            ...
            <div className='lg:ml-14 lg:pl-5 mt-6 lg:mt-0 lg:w-2/3'>
                ...
                <div className='text-[16px] lg:text-[20px] pt-3 font-medium'>
                    ...
                    <pre>Total Duration :   3 months</pre>
