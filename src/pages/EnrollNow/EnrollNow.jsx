...
const Enroll = () => {
  ...
  return (
    ...
    <div className="flex flex-col  lg:flex-row w-full gap-12 pt-4 lg:pt-4 lg:pl-[90px] pb-5 lg:w-[60%] rounded-xl bg-[#0A528E]">
    <div className='bg-[#0A528E]  ' >
     <form onSubmit={onSubmit} className='  h-[490px] w-[100%] md:ml-2 space-x-6 space-y-4 md:pr-[30px] '  >
        <h1 className='text-3xl  p-6 font-bold text-center  text-white lg:text-4xl' >Online Registration Form </h1>
 ...
 className="h-10 w-40 bg-orange ml-[80px] text-black font-medium   rounded-2xl  focus:outline-none">
        ...
        <div className=' '  >
          <h1 className='text-3xl font-bold pt-[130px] pb-[20px] text-center text-white  lg:pr-[95px] lg:text-4xl' >UPI Payment </h1>
          <div className='justify-center flex pt-3 ' >
            <img className=' h-[380px] w-[300px] rounded-xl  lg:mr-[85px]' src='./Images/qr code.png' alt="" />
          </div>
         <div className='text-md text-center p-7   text-white w-[105%] md:w-[120%] ' >
